...
(1, 'Taguan ng aso', 'Putang inang aso yan ang baho', 19, 2000, 'Screenshot (101).png'),
(2, 'Higaan ng aso', 'Galisin ang aso mo', 26, 3000, 'Screenshot (100).png'),
(3, 'Upuan', 'sadsad', 37, 2000, 'Screenshot (102).png');
...
INSERT INTO `tbl_orders` (`order_id`, `inv_id`, `name`, `email`, `product_name`, `order_quantity`, `price_perunit`, `total_price`, `status`) VALUES
(21, 1, 'sadasdasdsf', 'test@gmail.com', 'Taguan ng aso', 4, 2000, 8000, 'Approved'),
(22, 3, 'sadasdasdsf', 'test@gmail.com', 'Upuan', 3, 2000, 6000, 'Pending');
